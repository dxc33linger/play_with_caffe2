...
def AddLeNetModel(model, data):
    ...
    conv1 = brew.conv(model, data, 'conv1', dim_in=1, dim_out=20, kernel=5)  ### output size = (28 - 5)//1 + 1 = 24
...
def AddBookkeepingOperators(model):
    ...
    print(model.params) # [BlobReference("conv1_w"), BlobReference("conv1_b"), BlobReference("conv2_w"), BlobReference("conv2_b"), BlobReference("fc3_w"), BlobReference("fc3_b"), BlobReference("pred_w"), BlobReference("pred_b")]
    print(type(model.params)) # list
...
if __name__ == '__main__':
    ...
    workspace.ResetWorkspace(root_folder)   # clear workspace
    ...
    # model_helpers is used to build python class for 'nets'
    # it create a initialization net :init_net,  and a trainable net : exec_net
